...
$global:TssVerDateNET = "2022.10.22.0"
...
$NET_ScenarioTraceList = [Ordered]@{
	...
	"NET_HypHost"    = "PSR,SDP:HyperV, LBFO,VMM,HyperV-Host,HyperV-VMbus,Vmms,VmWp,VmConfig ETL log(s), VMM-debug, Netsh scenario=NetConnection"
	...
	"NET_SBSL"       = "Slow Boot/Slow Logon: Profile,Netlogon,WinLogon,GroupPolicy,DCLocator,GPresult,GPsvc,Auth ETL log(s), WhoAmI, Xperf SBSLboot, Netsh scenario=NetConnection; use with -StartAutologger; def. XperfMaxFile=16384"
...
function CollectNET_ProxyLog {
	...
	FwGetCertsInfo _Stop_ Basic
	getNetSh-http-show-UrlAcl _Stop_
	LogInfo "*** Hint: consider using \BIN\WinHTTPDiag.exe fro more Proxy troubleshooting ***" "Cyan"
	EndFunc $MyInvocation.MyCommand.Name
}
...
function CollectNET_SMBcliLog {
	...
	FwAddRegItem @("CSC", "Rpc", "SMB", "Tcp", "UNChard") _Stop_
...
function RunNET_SMBsrvPerm{
	...
	if ($global:Mode -iMatch "Permission") {
		FwPlaySound
		LogInfo "*** Next two steps: Please enter first a SMB-FOLDER-path then second a FILE-path - or hit [ENTER] to skip Permission step" "Cyan"
		...
		LogInfoFile "[SMB FOLDER: User provided answer:] $SMBfolder"
		...
		LogInfoFile "[SMB FILE-name: User provided answer:] $SMBfile"
...
function CollectNET_TLSLog {
	...
	if ((!(Get-Service -Name "IAS"  -ErrorAction Ignore)) -and ((Test-NetConnection -ComputerName $TLStestSite -CommonTCPPort HTTP).TcpTestSucceeded)) { #ToDo: verify - failed on NPS server
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCUNZTsZUw65oMd
# huL24qcJxo7TeJMh99TgWS0dkb1Wg6CCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgsFE79f+A
# FWoDRhv5TcHb2l8TtBjGcreiFVcAZCJezu4wQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAsFOYnPdy0YASySR8OKwT/JOnSV4plBFq7PCty4X0J
# LH1AMpx+D0j1IxDetg/EjBT/rNrA8zovIpYwpmgjzIB1NGjWMhV4uNZOP495/bFg
# xMC31iJjqps1uG1yi4BCTEWOQ3/SHPgildQK5gdBdeKHWwEvZvywZ6qLlcTRZSdK
# s4CM1Ey5+ZHWGd0OODDLmTO+fJnyHLBA7kuaQD4S57lBhxQNTjw5lWASw91b7LA9
# BGN7AP/fiSgCKELnovyu9nYejVARRpyLn+YsD4qOjROdoiuFhLNfiSgYKJ9XcCuE
# BrvB4qk14SDNPNSQZjmtc7BmV0FGJA4906mqP78SjiLMoYIXKzCCFycGCisGAQQB
# gjcDAwExghcXMIIXEwYJKoZIhvcNAQcCoIIXBDCCFwACAQMxDzANBglghkgBZQME
# AgEFADCCAVgGCyqGSIb3DQEJEAEEoIIBRwSCAUMwggE/AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIAto3L/8DLiXzU7R56BysHc922xZ7X/rXsMBRkIW
# tanFAgZjT/SUQv0YEjIwMjIxMDI2MTQyOTU2LjQ5WjAEgAIB9KCB2KSB1TCB0jEL
...
# LwYJKoZIhvcNAQkEMSIEILimTRynE7ncNm5zX3GVow1GCMOzEfFluQUdEjMC9+Ge
...
# S+oc8ISD6wHddKwBrTANBgkqhkiG9w0BAQsFAASCAgBcui9XyCB2GUsYh6/RXnFK
# raOfgMwbsoN+RPxUNHfF6nTsKdza9DwscYnaYiUVcuv1Cm/+hibPadkkJFZSVKjc
# cmrtP1bxrQ3Xe1Vny1vaMmKkMJQ+8vxX0bz6cBvr+vMoRYExRuFm/8DKCHZ8Gi5+
# dy3Bb+aTrCnpid2C0J6VQ+w5FVVw5dpwpgin2iQspX1p3HzbbL3QVqivW/+zsokr
# xB9ACfZc11IzOk7tMaqU8sArlTrM+K0M39h0lBKdwyBc6PwybxTTdTQM73Dw0xfG
# KBnuZp8lHRKug5GO1Gz3e0hduyrD069IC1fGuGFrxCr3ojE5wo8wGCEmE8a2CEyZ
# pD5k4twO8zN8apGJbfPHuyqDe3h8f3OwL+j2oRNxZ+NCQfIKopcQuygFDRPs0DtJ
# 35477ufYnfBAEwj8+4l6dYTWwjvwvSiOnlvUKKWwSaziUHdZ9smAMM1reBx9OurH
# yf1CdJqKCzSXDFSbLm3LvmQEM+koGDm2nTSX10gF/+gq0xtUYY4BqtT3DAErWV0s
# EGkGmlLBAkdRRVMsDPNaNnZjTUxGvvI7/EIk9fFmqup5+Q4Ltdd2ma6hggy3AVd9
# tj5V+rDmeHeltWG5cy4+aGDuzn+K7cGS8l+ucOcZEcJ+H9Fd/lMLpGFXqnJ/9VOf
# AIe3iIf/6+GoEHDeTiNG2g==
