...
"@
if (Test-Path "$location\install.bat") {Remove-Item "$location\install.bat"}
if (Test-Path "$location\uninstall.bat") {Remove-Item "$location\uninstall.bat"}
$installText    | Out-File -FilePath "$location\install.bat" -Encoding ASCII
$uninstallText  | Out-File -FilePath "$location\uninstall.bat" -Encoding ASCII
Start-Process notepad++ "$location\install.bat"
Start-Process notepad++ "$location\uninstall.bat"